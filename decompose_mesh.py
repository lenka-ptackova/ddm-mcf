"""Decomposition of a mesh into two submeshes - methods adapted for
meshes generated by functions in the script generate_meshes.py
...
def decompose(V: np.ndarray, H: np.ndarray, F: list,\
    ...
    """Decomposes meshes generated by functions in the script generate_meshes.py
    Input: vertices, halfedges, faces, type of mesh, division row, number
    of vertices in the dividing row, overlap
    Output: two lists, each containing vertices, halfedges, faces,
    boundary and interface of the sub-meshes (given by vertex indices)"""
